...
export const HeroSection: React.FC<HeroSectionProps> = ({ onExploreClick, onJoinClick }) => {
  ...
  return (
    <section ref={containerRef} id="hero" className="relative h-screen min-h-[720px] w-full flex items-center justify-center p-0 sm:p-4 md:p-6 overflow-hidden bg-canvas">
